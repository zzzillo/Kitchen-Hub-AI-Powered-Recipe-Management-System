  ...
  <section className="bg-transparent">
    <div className="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
      <div className="space-y-8">
        <div className="mx-auto max-w-3xl text-center motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-left-3 motion-safe:duration-500 lg:mx-0 lg:max-w-none lg:text-left">
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
          {recipeIdeaSamples.map((sample) => (
            <article
              key={sample.title}
              className="mx-auto w-full max-w-md overflow-hidden rounded-[2rem] bg-white shadow-[0_14px_28px_rgba(23,37,22,0.06)] ring-1 ring-inset ring-[#e6dece] motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-bottom-3 motion-safe:duration-500 transition duration-300 hover:-translate-y-1 md:max-w-none"
            >
